...
if __name__ == '__main__':
    ...
    aligo = Aligo()
    aligo.upload_folder
    # [BaseDrive(drive_id='216154121', used_size=0, total_size=-1), BaseDrive(drive_id='237677030', used_size=15301068, total_size=-1), BaseDrive(drive_id='645810972', used_size=796973749007, total_size=-1), BaseDrive(drive_id='79808', used_size=120732746780, total_size=10737418240), BaseDrive(drive_id='79809', used_size=88040578, total_size=0), BaseDrive(drive_id='9771618', used_size=308463267270, total_size=-1)]
    print(aligo.create_folder(parent_file_id="65a00c994b40f9930e854649bc593690b9ed155a", folder_name=name))
