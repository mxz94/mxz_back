...
const socialIcons: SocialIcons = {
    WRITE: `<svg t="1712655486976" class="icon-tabler" viewBox="0 0 1025 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2671" width="24" height="24"><path d="M1004.864 167.296c-25.28-24.448-66.304-24.448-91.584 0l-523.264 508.736c-25.28 24.384-25.28 64.064 0 88.64 25.28 24.384 66.24 24.384 91.584 0l523.264-508.736C1030.144 231.424 1030.144 191.744 1004.864 167.296z" p-id="2672"></path><path d="M884.032 511.104c-25.6 0-46.464 20.16-46.464 45.056l0.256 257.408c-4.288 39.296-20.352 54.656-64.704 58.432L151.36 872.32c-41.216-5.312-54.784-22.784-57.728-65.408L93.312 213.504c3.584-41.408 18.24-57.408 62.656-61.504L791.68 151.68c25.6 0 46.464-20.16 46.464-45.056 0-24.832-20.8-44.992-46.464-44.992L84.992 62.08c-47.296 4.032-84.352 42.24-84.736 88.96L0.64 880.064c4.224 45.952 44.032 81.92 92.608 81.92l49.408 0 0 0.384 645.44-0.384 0 0 49.344 0c51.392 0 93.12-40.32 93.12-90.048l0-44.992 0.256 0L930.56 556.16C930.56 531.328 909.76 511.104 884.032 511.104z" p-id="2673"></path></svg>`,
    RSS: `<svg
...
d="M12 20.001h2C14 14.486 9.514 10 4 10v2c4.411 0 8 3.589 8 8.001z"></path><circle cx="6" cy="18" r="2"
  ...
  Run: `<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="24"
            height="24"
